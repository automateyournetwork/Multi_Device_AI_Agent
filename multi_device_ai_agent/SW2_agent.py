...
def run_show_command_tool(input_text: str) -> dict:
    ...
    Example: "S2: show ip interface brief"
    """
    try:
...
If the configuration looks like this: Action Input: "S2: interface Ethernet0/1\ndescription P2P Link with R2 Eth0/1"
